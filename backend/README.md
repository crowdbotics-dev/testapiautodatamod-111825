...
## Project Structure
    ...
    ├── testapiautodatamod_111825  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_111825`
...
2. Clone this repo and `cd testapiautodatamod_111825`
